...
hidden if the `project1_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `project1_DEVELOPER_MODE` to the configure
...
Runs the executable target `project1_exe`.
